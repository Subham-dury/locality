...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> handleDataNotFoundException(ResourceNotFoundException ex,
			WebRequest webRequest){
	...
	public ResponseEntity<ExceptionResponse> handleUnauthorizedException(NotAuthorizedException ex,
			WebRequest webRequest){
